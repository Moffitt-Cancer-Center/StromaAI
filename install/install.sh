...
EOF
        ...
        if [[ "${_merge_config:-0}" == "1" ]]; then
            local managed_vars=("STROMA_INSTALL_DIR" "STROMA_SHARED_ROOT" "STROMA_HEAD_HOST" \
                ...
                "STROMA_MODEL_PATH" "STROMA_MODEL_NAME" "STROMA_CONTAINER" "STROMA_SLURM_PARTITION" \
                "STROMA_SLURM_ACCOUNT" "STROMA_SLURM_SCRIPT" "STROMA_SLURM_WALLTIME" "STROMA_MAX_BURST_WORKERS" \
